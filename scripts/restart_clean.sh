...
echo ""
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${BLUE}          🧹 Shree - Clean Restart Script 🧹                  ${NC}"
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""

# Step 1: Kill all Python trading processes
echo -e "${YELLOW}Step 1: Killing all Python trading processes...${NC}"
PYTHON_PIDS=$(lsof -i :4001 2>/dev/null | grep Python | awk '{print $2}' | sort -u)
...
REMAINING=$(lsof -i :4001 2>/dev/null | grep ESTABLISHED | grep -v JavaAppli || true)
if [ -z "$REMAINING" ]; then
...
IB_RUNNING=$(lsof -i :4001 2>/dev/null | grep JavaAppli | grep LISTEN || true)
...
lsof -i :4001 2>/dev/null | head -5 || echo "  None"
echo ""
