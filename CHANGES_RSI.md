...
- Added reusable RSI computation helper (`shree/features/indicators.py`) with tests for short history and trend behaviour.
- Introduced `RSITrendPullbackFilter` (`shree/hybrid/rsi_trend_filter.py`) to align RSI signals with EMA50 trend, ATR bounds, and session-aware adjustments.
